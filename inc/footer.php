    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <p style="color: #FFF">Huancayo UCCI</p>
                ...
                E-mail: <a href="#" target="_blank" style="color: #5bc0de"> &nbsp; 42646122@continental.edu.pe</a>
            </div>
        </div>
    </div>
    <br><br><br>
    <h5 class="text-center tittles-pages-logo text-footer">Ecommerce Agricola &copy; 2021</h5>
</footer>
